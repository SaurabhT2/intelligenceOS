...
- `index.ts` — curate the public export surface. Nothing outside this file's export list should be considered stable or importable by a consumer. See `docs/INTEGRATION_GUIDE.md` for the maintained, annotated list.
