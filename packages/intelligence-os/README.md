...
Everything not listed in `src/index.ts` is an internal implementation detail and may change without notice between minor versions — see `docs/INTEGRATION_GUIDE.md` in the source repository for the full, maintained list of what's public vs. internal.
